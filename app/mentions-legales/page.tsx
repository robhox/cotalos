  ...
  return (
    ...
    >
      <section className="space-y-2">
        ...
        <p>Numero de TVA: {legal.vatNumber}</p>
        <p>Adresse: {legal.address}</p>
        <p>Email: {legal.contactEmail}</p>
      </section>

      <section className="space-y-2">
        <h2 className="text-lg font-semibold">Hebergement</h2>
        <p>{legal.hostName}</p>
      ...
      <section className="space-y-2">
        <h2 className="text-lg font-semibold">Cadre annuaire et non-affiliation</h2>
        <p>Les fiches sont alimentees a partir de donnees publiques.</p>
        <p>La presence d un commerce dans l annuaire ne constitue aucune affiliation commerciale avec cotalos.be.</p>
        <p>cotalos.be ne propose pas encore de service de commande en ligne active ni de paiement.</p>
      </section>
    </LegalPageLayout>
  );
}
